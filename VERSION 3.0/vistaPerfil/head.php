...
<body class="bg-gray-100 min-h-screen text-gray-800 flex flex-col">
  ...
  <!-- Navbar -->
  <!-- En perfil.html, asegúrate de que el header sea así: -->
<header class="bg-blue-700 text-white p-4 shadow-lg">
  <div class="container mx-auto flex justify-between items-center">
    ...
    <nav class="flex items-center space-x-6">
      ...
      <a href="perfil.php" class="relative py-2 hover:underline font-semibold border-b-2 border-white">Mi Perfil</a>
